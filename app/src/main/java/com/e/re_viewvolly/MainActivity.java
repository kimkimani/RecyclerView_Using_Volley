...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //define views
        productView = findViewById(R.id.recyclerviewid);
        layoutManager = new LinearLayoutManager(getApplicationContext());
        productView.setLayoutManager(layoutManager);
        progressBarLoading = findViewById(R.id.progressBarLoading);
        //initialize adapter
        listAdapter = new ListAdapter(MainActivity.this,listUnitList);
    ...
    private void parseData(JSONArray response) {
        ...
        for(int i =0; i< response.length(); i++){
            ...
            try{
                ...
                listUnit.setStatus(jsonObject.getString("status"));
                listUnit.setTime(("Time:")+jsonObject.getString("Time"));
                listUnit.setLeague(("league:")+jsonObject.getString("league"));
                listUnit.setMatch(("Match:")+jsonObject.getString("Match"));
                listUnit.setTip(("Tips:")+jsonObject.getString("Tips"));
                listUnit.setOdd(("Odds :")+jsonObject.getString("Odds"));
                listUnit.setResults(("Results :")+jsonObject.getString("Results"));
                listUnit.setCountry(jsonObject.getString("country"));
